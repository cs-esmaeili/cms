...
<!--
    ...
    Version: 1.4.0
    Author: mellatweb team
    Website: https://www.mellatweb.com
    Purchase: https://www.ellatweb.com/
    Support: https://wwwmellatweb.com/
    License: You must have a valid license purchased only from MELLATWEB (the above link) in order to legally use the theme for your project.
    Copyright 2018.
-->

<html lang="en">
<!--sherad by mellatweb.com -->
...
<head>
    ...
    <link rel="icon" type="image/png" href={{ asset('system/fav.png') }}>
