<div class="nk-blog-post">
    ...
    <h2 class="nk-post-title h4" style="text-align: right"><a href="blog-article.html">{{ $data->title }}</a></h2>
    <div class="nk-post-text" style="text-align: right">
        <p>{{ $data->description }}</p>
    </div>
    <div class="nk-gap"></div>
    <a href="blog-article.html" class="nk-btn nk-btn-rounded nk-btn-color-dark-3 nk-btn-hover-color-main-1">ادامه مطلب</a>
